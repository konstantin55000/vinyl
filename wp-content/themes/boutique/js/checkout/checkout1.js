...
//   
wc_checkout_params.checkout_url = 'https://shop.westernbid.info';             
$.ajax({
	type:		'POST',
	url:		'https://shop.westernbid.info',
	data:		$form.serialize(),
	success:	function( data ) {
    ...
    //$form.submit();
				...
				$.ajax({
					...
					success:	function( result ) {
						try {
							alert('scond' + JSON.stringify(result));;
