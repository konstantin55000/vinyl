...
class WoocommerceAliexpressDropshipping_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'woocommerce-aliexpress-dropshipping'));
        }
...
<!-- <video width="400" controls>
  <source src="https://www.youtube.com/watch?v=MFX5ilX8JCk" type="video/mp4">
  Your browser does not support HTML5 video.
</video> -->

<iframe width="560" height="315" src="https://www.youtube.com/watch?v=u-6YX-8zS6s&t=9s" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>


<p>
you must install the chrome extension to be able to use the plugin 
<a href="https://goo.gl/14PWXi" target="_blank">Download link</a>.
</p>
